...
func HandleBearerAuth(username string, base64ConversationID string, handlerFunc quicssh.UnauthenticatedBearerFunc) http.HandlerFunc {
...
func HandleJWTAuth(username string, newConv *quicssh.Conversation, handlerFunc quicssh.AuthenticatedHandlerFunc) quicssh.UnauthenticatedBearerFunc {
